...
using Covid19.AI.Animations;
using Covid19.AI.Depreceated.Actions;
using Covid19.AI.Depreceated.SaveData;
using Covid19.AI.Depreceated.StateMachine;
using Covid19.AI.Depreceated.UI;
using Covid19.Utils;
using UnityEngine;
...
namespace Covid19.AI.Depreceated
{
    [RequireComponent(typeof(NavMeshAgent))]
    [RequireComponent(typeof(AnimateAI))]
    [Obsolete("Not used anymore, use AgentNPC",false)]
